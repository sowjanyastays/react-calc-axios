  ...
  return (
    <div className='Aboutme'>
      ...
      <section className='profile'>
        ...
        <br></br>
        currently pursuing Bachelor of Engineering in the same. 
        Willing to enhance and explore my technical
        <br></br>
      ...
      <strong>Achievements: <br></br></strong>
    Won the Anna University Inter-Zonal Badminton Competition<br></br>
     2022 held in Rajalakshmi Engineering College.<br></br>
    • Active member of the college's Coder's club and<br></br>
    GDSC(Google Developer's Student Club).<br></br>
    • Attended E : summit 2019 held by IITM E-CELL<br></br>
    • Won first place in Intra-college competition “Deadly red” and<br></br>
    “Capre Logicana” held by the college's Math Club.<br></br>
    • Active member and leader of the colleges Badminton and <br></br>
     Carrom clubs respectively.<br></br>
